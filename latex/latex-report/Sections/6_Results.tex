...
\centering
\subfloat[]{{\includegraphics[scale=0.4]{latex/figures/ising_J_lmbda_0_0001.pdf}}}
\qquad
\subfloat[]{{\includegraphics[scale=0.4]{latex/figures/ising_J_lmbda_0_001.pdf}}}
\qquad
\subfloat[]{{\includegraphics[scale=0.4]{latex/figures/ising_J_lmbda_0_01.pdf}}}
\qquad
\subfloat[]{{\includegraphics[scale=0.4]{latex/figures/ising_J_lmbda_0_1.pdf}}}
\caption{figure text}
\label{fig:fig1}
\end{figure}
