...
\centering
\subfloat[]{{\includegraphics[scale=0.5]{latex/figures/ising_J_lmbda_0_0001.pdf}}}
\qquad
\subfloat[]{{\includegraphics[scale=0.5]{latex/figures/ising_J_lmbda_0_001.pdf}}}
\qquad
\subfloat[]{{\includegraphics[scale=0.5]{latex/figures/ising_J_lmbda_0_01.pdf}}}
\caption{figure text}
\label{fig:fig1}
\end{figure}
